...
public final class HomeserverInformation {
  private @Nullable JsonElement $json;

  private final String base_url;

  public HomeserverInformation(String base_url) {
  ...
  public static HomeserverInformation fromJson(JsonElement $json) {
    ...
    HomeserverInformation $constructed = new HomeserverInformation(
        base_url);
  ...
  public String toString() {
    ...
    $string.append("HomeserverInformation { ");
